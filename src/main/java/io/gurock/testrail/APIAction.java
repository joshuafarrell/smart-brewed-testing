...
public class APIAction {
    ...
    APIClient client = new APIClient("https://smartbrewed.testrail.io/");
    String user = "joshuatfarrell@gmail.com";
    String password = "DeMark123";
    ...
    public int getProjects() {
        try {
            JSONObject response = (JSONObject) client.sendGet("get_projects/");
            return Integer.parseInt(response.get("id").toString());
        } catch (IOException | APIException e) {
            LOGGER.info(e);
        }
