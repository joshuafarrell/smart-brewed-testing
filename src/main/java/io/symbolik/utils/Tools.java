...
public class Tools {
    ...
    public static void captureElementScreenshot(WebDriver driver, WebElement target, String filePath) {
        ...
        System.out.println("Screenshot time");
        if (mkdirs) {
     ...
     * @param filePath
     */
    public static void captureBrowserScreenshot(WebDriver driver, String name, String filePath) {
        final boolean mkdirs = new File(filePath).mkdirs();
